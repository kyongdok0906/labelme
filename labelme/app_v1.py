...
from labelme.widgets  import CustomGridH
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        self.grades_widget = CustomGridH()
        self.grades_dock.setWidget(self.grades_widget)
        print(self.grades_widget.height())
        ...
        # for dock in ["grades_dock", "flag_dock", "label_dock", "shape_dock", "file_dock"]:
        for dock in ["grades_dock", "label_dock", "shape_dock", "file_dock"]:
        ...
        threading.Timer(0, self.getGrades).start()
    ...
    def getGrades(self, userInfo=None):
        url = 'https://gb9fb258fe17506-apexdb.adb.ap-seoul-1.oraclecloudapps.com/ords/lm/v1/labelme/codes/grades'
        headers = {'Authorization': 'Bearer E73E8F2B47D2B1D0611741859A247E473A45687E'}
